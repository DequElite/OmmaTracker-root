...
import ReviewTaskRouter from "./ReviewTaskRouter";
import CreateTaskRouter from "./CreateTaskRouter";
...
export default function InitRoutes(app:Express): void {
    ...
    app.use(API_DIR + '/tasks', ReviewTaskRouter);
    app.use(API_DIR + '/tasks', CreateTaskRouter);
}
